...
echo "phpmyadmin phpmyadmin/reconfigure-webserver 
multiselect" | sudo debconf-set-selections
...
# Git config
echo "Git config"
git config --global user.email "eduard.vish@rambler.ru"
git config --global user.name "Eduard Vyshkvartsev"
